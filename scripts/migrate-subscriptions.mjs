...
const sampleSubscriptions = JSON.parse(readFileSync('./data/subscriptions.json', 'utf8'));
...
console.log(
  'Please run: npx convex run subscriptions:addSubscription --args \'{"channelId":"UCr-5TdGkKszdbboXXsFZJTQ","channelName":"Gamefromscratch","channelLogoUrl":"https://picsum.photos/seed/UCr-5TdGkKszdbboXXsFZJTQ/100/100.jpg","channelUrl":"https://www.youtube.com/channel/UCr-5TdGkKszdbboXXsFZJTQ"}\''
);
