...
const mockUseConvexSubscriptions = useConvexSubscriptions as jest.MockedFunction<typeof useConvexSubscriptions>
...
describe('Settings Integration', () => {
  ...
  it('allows filtering by search query', async () => {
    const { useDebouncedSearch } = require('../lib/hooks/use-debounced-search')
