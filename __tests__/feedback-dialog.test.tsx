...
describe('FeedbackDialog', () => {
  ...
  it('submits feedback form with valid data', async () => {
    const { useFeedback } = require('../lib/hooks/use-feedback')
    const mockSubmitFeedback = useFeedback().submitFeedback
    ...
    fireEvent.change(screen.getByLabelText(/Message/), { target: { value: 'This is a valid feedback message that is long enough' } })
  ...
  it('shows success message after successful submission', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/Category/), { target: { value: 'ui-ux' } })
    fireEvent.change(screen.getByLabelText(/Message/), { target: { value: 'Valid feedback message' } })
  ...
  it('shows anonymous notice when not signed in', () => {
    ...
    expect(screen.getByText(/Your feedback will still be submitted anonymously/)).toBeInTheDocument()
  })
})