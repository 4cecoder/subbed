...
export const FeedHeader: React.FC<FeedHeaderProps> = React.memo(
  ({ selected, subs, query, loading, total, onQueryChange, onRefresh, onClear }) => {
    ...
    return (
      <div className="mb-6">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
          <div>
            <h2 className="text-xl font-semibold flex items-center gap-2">{getTitle()}</h2>
            {selected === 'all' && total != null && (
              <p className="text-sm text-muted-foreground mt-1">Showing {total} recent videos</p>
            )}
          </div>
